...
4. combination of contact details stored in your Apple Contacts: first/last names or corresponding phonetic names, nicknames, organisations
...
Alternatively, you can make calls using Alfred's Contacts Feature. There will be 3 contact actions available for you to choose from in **_Alfred's Contacts Feature_**: Skype Call, FaceTime Call and Phone Amego Call.
